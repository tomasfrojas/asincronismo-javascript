...
function fetchData(urlApi, callback) {
  ...
  //El metodo .open realiza la petición de apertura de comunicación, el metodo puede ser 'GET' o 'POST', luego se envia la URL, si es asincrono (true o false), usuario y contraseña. En este caso solo se utiliza el metodo, la url y async
...
//Se invoca el metodo fetchData() pasandole como argumentos la variable API concatenada con la cadena 'products' para acceder a la URL de la API deseada, y una función anónima que recibe 2 parámetros (un objeto de error y un arreglo que almacena todos los objetos traidos por la API).
